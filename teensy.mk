# based on github.com/apmorton/teensy-template
...
INCLUDE_FLAGS =
OPTIONS = -DUSB_SERIAL -DLAYOUT_US_ENGLISH ${INCLUDE_FLAGS}
...
CPPFLAGS = -Wall -g -Ofast -mthumb -ffunction-sections -fdata-sections -nostdlib -MMD $(OPTIONS) -DTEENSYDUINO=124 -DF_CPU=$(TEENSY_CORE_SPEED) -Isrc -I$(COREPATH)
...
# linker options
LDFLAGS = -Ofast -Wl,--gc-sections -mthumb
...
ifeq ($(TEENSY), 30)
    ...
    LDFLAGS += -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -T$(LDSCRIPT)
    #LIBS += -larm_cortexM4lf_math # not found
else
